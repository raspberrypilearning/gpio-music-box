...
GPIO.add_event_detect(15, GPIO.RISING, callback=note_a, bouncetime=200)  
GPIO.add_event_detect(17, GPIO.RISING, callback=note_b, bouncetime=200)
GPIO.add_event_detect(18, GPIO.RISING, callback=note_c, bouncetime=200)  
